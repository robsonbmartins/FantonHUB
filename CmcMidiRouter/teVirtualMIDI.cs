...
namespace TobiasErichsen.teVirtualMIDI {
	...
	public class TeVirtualMIDI {
		...
		static TeVirtualMIDI() {
			IntPtr ptr = virtualMIDIGetVersion(ref fVersionMajor, ref fVersionMinor, ref fVersionRelease, ref fVersionBuild );
			fVersionString = System.Runtime.InteropServices.Marshal.PtrToStringUni(ptr) ?? "Unknown";
		}
